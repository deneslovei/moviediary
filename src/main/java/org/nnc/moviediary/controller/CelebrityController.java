...
public class CelebrityController {
	...
	@RequestMapping(value = "/save-celebrity", method = RequestMethod.GET)
	public String saveCelebrity(final Model model, @RequestParam("celebrityId") final String celebrityId, @RequestParam("visible") final Boolean visible,
